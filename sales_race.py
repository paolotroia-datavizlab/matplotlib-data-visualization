...
df_pivot.to_csv('superstore_cleaned.csv')
...
df_cleaned = pd.read_csv('superstore_cleaned.csv', index_col = 'Year')
...
bar_chart_race(
    'sales_race_linkedin.gif',    # Output filename 
...
bar_chart_race(
    'sales_race_instagram_feed.gif',    # Output filename
...
bar_chart_race(
    'sales_race_instagram_story.gif', # Output filename
